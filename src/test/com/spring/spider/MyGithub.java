package com.spring.spider;

import com.geccocrawler.gecco.GeccoEngine;
import com.geccocrawler.gecco.annotation.*;
import com.geccocrawler.gecco.spider.HtmlBean;

@Gecco(matchUrl = "https://github.com/liuenci/mmall", pipelines = "consolePipeline")
public class MyGithub implements HtmlBean {
    ...
    public static void main(String[] args) {
        GeccoEngine.create()
                //工程的包路径
                .classpath("com.spring.spider")
                //开始抓取的页面地址
                .start("https://github.com/liuenci/mmall")
                //开启几个爬虫线程
                .thread(1)
                //单个爬虫每次抓取完一个请求后的间隔时间
                .interval(2000)
